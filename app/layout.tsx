  ...
  return (
    <html lang="en">
      <body className={classNames(poltawski.className, mplus.className)}>
        ...
        <div className='flex flex-row whitespace-nowrap type-body-1 will-change-transform group'>
          {new Array(2).fill(null).map((_, i) => <div key={i} className={classNames(
            {
            ...
            {quotes.map((quote, quoteI) => <span key={quote} className={classNames(
